...
{
    public class NavigationLightsResult : ResultBase
    {
        private static ResultEnum Validade(bool lightNavigationnOn, bool _engOneRunning)
        {
            if (!lightNavigationnOn && _engOneRunning)
